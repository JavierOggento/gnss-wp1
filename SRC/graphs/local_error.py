...
def local_error(nav_solution, los_data):
    if nav_solution == 'GPS':
        constellation_id = 'G'
        constellation = 'GPS'
    else:
    ...
    PlotConf = {
        "Title": "Simulated GNSS " + constellation + " LOCAL Error",
        "Type": "Lines",
        "FigSize": (8.4, 7.6),
        "Grid": True,
        "Marker": ".",
    ...
    PlotConf["yData"][Label] = los_data[LOS_IDX["LOCAL-ERR"]][filter_condition]
