...
def range_rate(nav_solution, los_data):
    if nav_solution == 'GPS':
        constellation_id = 'G'
        constellation = 'GPS'
    else:
    ...
    PlotConf = {
        "Title": "Simulated GNSS " + constellation + " Geometrical Range Rate",
        "Type": "Lines",
        "Grid": True,
        "FigSize": (8.4, 7.6),
        "Marker": ".",
    ...
    PlotConf["yLabel"] = "Geometrical Range Rate [m/s]"
    ...
    PlotConf["yData"][Label] = los_data[LOS_IDX["RANGE-RATE"]][filter_condition]
